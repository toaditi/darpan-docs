...
<div className="rm-card">
  <p><strong>Downloadable API source artifacts</strong> <span className="rm-pill">Shipped · May 6, 2026</span></p>
  <p className="rm-muted">API-backed source artifacts are downloadable from run results; corrected order-extraction windows for API sources.</p>
</div>

<p className="rm-muted">Release numbering restarts at v1.0.0 with the next tag — see [Release updates](/releases/updates) for why.</p>
