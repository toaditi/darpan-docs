...
<div className="rm-card">
  <p><strong>v1.0.3 — new release baseline</strong> <span className="rm-pill">Shipped · Jul 3, 2026</span></p>
  <p className="rm-muted">First tag on Darpan's new independent baseline — the version production deploys pin to. No product changes; see [Release updates](/releases/updates).</p>
</div>
