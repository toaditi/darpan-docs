...
<div className="rm-card">
  ...
  <p className="rm-muted">Production images build directly from the tag; deploys pin this version. No product changes; see [Release updates](/releases/updates).</p>
</div>

<div className="rm-card">
  <p><strong>v1.0.0 — new release baseline</strong> <span className="rm-pill">Shipped · Jul 3, 2026</span></p>
  <p className="rm-muted">First tag on Darpan's new independent baseline. No product changes; see [Release updates](/releases/updates).</p>
</div>
