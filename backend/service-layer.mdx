...
Do not document invented REST endpoints. When adding API docs, start from verified facade service names and document the JSON-RPC envelope, required parameters, auth expectations, side effects, and response fields.
