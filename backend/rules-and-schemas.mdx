...
When documenting a workflow that depends on rules or schemas, identify which backend contract owns the behavior. Do not describe rules or schemas as browser-local configuration.
